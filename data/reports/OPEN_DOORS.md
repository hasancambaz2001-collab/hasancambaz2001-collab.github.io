...
2. PMData post-08-14 5m/15m L2 (key in env, not committed). No Mar–May bulk. Nautilus has no historical L2.
3. Public trade prints aligned to our rest price (queue trade_index).
4. Gamma settlement for purged 5m — use dump-native tape.
5. 06dc daily/monthly books are NOT in l2_recorder (5m/15m only). Truth = dump + paper_06dc + T6. T6 n≥20 still open.
